...
from rasa_nlu.classifiers.embedding_bert_intent_classifier import EmbeddingBertIntentClassifier
...
from rasa_nlu.extractors.jieba_pseg_extractor import JiebaPsegExtractor
...
component_classes = [
    ...
    DucklingHTTPExtractor, EntitySynonymMapper, JiebaPsegExtractor, # customize
    # featurizers
...
old_style_names = {
    ...
    "jieba_pseg_extractor":"JiebaPsegExtractor",
    ...
    "intent_classifier_tensorflow_embedding_bert":"EmbeddingBertIntentClassifier",
}
