...
def component_config_from_pipeline_name(
        name,  # type: Text
...
class RasaNLUModelConfig(object):
    ...
    def for_component_name(self, name, defaults=None):
        return component_config_from_pipeline_name(name, self.pipeline, defaults)
